...
public class A1083359_Project2_Game
{
    ...
    private final ArrayList<A1083359_Project2_Agent> explorers = new ArrayList<>();
    // The deck of cards to be used for the game.
    private final ArrayList<A1083359_Project2_Card> deck = new ArrayList<>();
    // A tomb-like path for exploration.
    private final ArrayList<A1083359_Project2_Card> path = new ArrayList<>();
    // There are 5 sections (5 rounds) of exploration in the tomb, and one particular artifact is deposited in each section.
    private final ArrayList<A1083359_Project2_Artifact> artifacts = new ArrayList<>();
    // The Hazards that occurred during the game play.
    private final ArrayList<A1083359_Project2_Hazard> occurredHazards = new ArrayList<>();

    public A1083359_Project2_Game()
    {
        this.explorers.add(new A1083359_Project2_Agent(0));
        this.explorers.add(new A1083359_Project2_Agent(1));
        this.explorers.add(new A1083359_Project2_Agent(2));
        this.explorers.add(new A1083359_Project2_Agent(3));
        this.explorers.add(new A1083359_Project2_Agent(4));
        this.explorers.add(new A1083359_Project2_Agent(5));
    ...
    public void runGame()
    {
        for (int round = 0; round < ROUND; round++)
        {
            ...
            /************ START OF YOUR CODE ************/
            for(A1083359_Project2_Agent explorer:this.explorers) {
                explorer.setInExploring(true);
            } 

            for(int k=0;k<path.size();k++){
                if(path.get(k) instanceof A1083359_Project2_Gemstone){                	
                    deck.add(path.get(k));  
                                
                }else if(path.get(k) instanceof A1083359_Project2_Hazard){
            ...
            for(int d=0;d<deck.size();d++){
                if(deck.get(d) instanceof A1083359_Project2_Artifact){
            ...
            for(A1083359_Project2_Card card:deck){
                if(card instanceof A1083359_Project2_Gemstone){
                    ((A1083359_Project2_Gemstone)card).resetValue();
                }
            } 
            ...
            while (this.isAnyoneStay())
            {
                ...
                /************ START OF YOUR CODE ************/
                ArrayList<A1083359_Project2_Hazard> occurredHazard = new ArrayList<>();
                ...
                for(int a=0;a<deck.size();a++){
                    ...
                    //如果抽的牌為寶石
                    if(path.get(a) instanceof A1083359_Project2_Gemstone){

                        ((A1083359_Project2_Gemstone)path.get(a)).share(getStayExplorers());

                    //如果抽的牌為災難
                    }else  if(path.get(a) instanceof A1083359_Project2_Hazard){
                        for(int b=0;b<occurredHazard.size();b++){

                            if (occurredHazard.get(b).getType()==path.get(a).getType()) {
                                occurredHazards.add((A1083359_Project2_Hazard) path.get(a));

                                for(A1083359_Project2_Agent explorer:this.getStayExplorers()) {
                                    explorer.flee();
                                }
                            }
                        ...
                        occurredHazard.add((A1083359_Project2_Hazard)path.get(a));
                    }
                  ...
                  // doNothing(100); 
                    ...
                    //doNothing(400);
                    //輸出持有寶石數或離開
                    for(A1083359_Project2_Agent getGem:this.explorers) {
                ...
                A1083359_Project2_Environment environment = this.createEnvironment();

                /************ START OF YOUR CODE ************/
                ArrayList<A1083359_Project2_Agent> leave = new ArrayList<>();
                int count=0;
                int leavenum=0;
                
                for(A1083359_Project2_Agent action:getStayExplorers()) {
                    leavenum++;
                ...
                //如果抽的牌為災難
                if(path.get(a) instanceof A1083359_Project2_Hazard){
                   
                    if(occurredHazards.size()==1){
                        for(A1083359_Project2_Hazard Hazard:occurredHazards ){
                 ...
                 //如果抽的牌為神器       
                }else if(path.get(a) instanceof A1083359_Project2_Artifact){                 
                    
                    if(leave.size()==1){
                        
                        ((A1083359_Project2_Artifact)path.get(a)).share(leave);                                            
                    }
                }
                if(leave.size()==1){
       
                    for(int s=0;s<path.size();s++){
                        if(path.get(s) instanceof A1083359_Project2_Artifact){
                                
                            ((A1083359_Project2_Artifact)path.get(s)).share(leave);                             
                        }   
                    }//doNothing(300);
                                                                                        
               }

               for(A1083359_Project2_Agent leavee: leave){
               ...
               if(count==leavenum) {
                   if(occurredHazards.size()==1){
                    ...
                    for(A1083359_Project2_Card gems:path) {
                        if(gems instanceof A1083359_Project2_Gemstone){
                            ((A1083359_Project2_Gemstone)gems).share(leave);          
                        }
                    }              
                }
            }
            ...
            for(A1083359_Project2_Agent stone:this.explorers) {
    ...
    {
        this.deck.add(new A1083359_Project2_Hazard(0));
        this.deck.add(new A1083359_Project2_Hazard(0));
        this.deck.add(new A1083359_Project2_Hazard(0));
        this.deck.add(new A1083359_Project2_Hazard(1));
        this.deck.add(new A1083359_Project2_Hazard(1));
        this.deck.add(new A1083359_Project2_Hazard(1));
        this.deck.add(new A1083359_Project2_Hazard(2));
        this.deck.add(new A1083359_Project2_Hazard(2));
        this.deck.add(new A1083359_Project2_Hazard(2));
        this.deck.add(new A1083359_Project2_Hazard(3));
        this.deck.add(new A1083359_Project2_Hazard(3));
        this.deck.add(new A1083359_Project2_Hazard(3));
        this.deck.add(new A1083359_Project2_Hazard(4));
        this.deck.add(new A1083359_Project2_Hazard(4));
        this.deck.add(new A1083359_Project2_Hazard(4));
        
        this.deck.add(new A1083359_Project2_Gemstone(0, 1));
        this.deck.add(new A1083359_Project2_Gemstone(1, 2));
        this.deck.add(new A1083359_Project2_Gemstone(2, 3));
        this.deck.add(new A1083359_Project2_Gemstone(3, 4));
        this.deck.add(new A1083359_Project2_Gemstone(4, 5));
        this.deck.add(new A1083359_Project2_Gemstone(4, 5));
        this.deck.add(new A1083359_Project2_Gemstone(5, 7));
        this.deck.add(new A1083359_Project2_Gemstone(5, 7));
        this.deck.add(new A1083359_Project2_Gemstone(6, 9));
        this.deck.add(new A1083359_Project2_Gemstone(7, 11));
        this.deck.add(new A1083359_Project2_Gemstone(7, 11));
        this.deck.add(new A1083359_Project2_Gemstone(8, 13));
        this.deck.add(new A1083359_Project2_Gemstone(9, 14));
        this.deck.add(new A1083359_Project2_Gemstone(10, 15));
        this.deck.add(new A1083359_Project2_Gemstone(11, 17));
        
        this.artifacts.add(new A1083359_Project2_Artifact(0, 5));
        this.artifacts.add(new A1083359_Project2_Artifact(1, 7));
        this.artifacts.add(new A1083359_Project2_Artifact(2, 8));
        this.artifacts.add(new A1083359_Project2_Artifact(3, 10));
        this.artifacts.add(new A1083359_Project2_Artifact(4, 12));
    }
    ...
    private ArrayList<A1083359_Project2_Agent> getStayExplorers()
    {
        /********************************* TODO (Checkpoint 2) *********************************
        ...
        /************ START OF YOUR CODE ************/
        ArrayList<A1083359_Project2_Agent> check = new ArrayList<A1083359_Project2_Agent>();
	    	
        for(A1083359_Project2_Agent getStay:this.explorers) {    		
    ...
    private ArrayList<A1083359_Project2_Agent> getWinners()
    {
        /********************************* TODO (Checkpoint 2) *********************************
        ...
        ArrayList<A1083359_Project2_Agent>  winners=new ArrayList<>();
    ...
    private A1083359_Project2_Environment createEnvironment()
    {
        A1083359_Project2_Environment environment = new A1083359_Project2_Environment();
