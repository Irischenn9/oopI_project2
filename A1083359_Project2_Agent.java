...
public class A1083359_Project2_Agent
{
    ...
    private final ArrayList<A1083359_Project2_Artifact> ownedArtifacts = new ArrayList<>();
    
    public A1083359_Project2_Agent(int number)
    {
        this.number = number;
    ...
    public ArrayList<A1083359_Project2_Artifact> getOwnedArtifacts()
    {
        /********************************* TODO (Checkpoint 2) *********************************
    ...
    public int totalValue()
    {
        ...
        if(ownedArtifacts.size()!=0){
            i=getGemsInsideTent();
            for(A1083359_Project2_Artifact getStay:ownedArtifacts) {
    ...
    public void act(A1083359_Project2_Environment environment)
    {
        if (this.inExploring)
        {
