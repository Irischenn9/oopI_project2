...
public class A1083359_Project2_Artifact extends A1083359_Project2_Treasure
{
    // It determines whether this artifact is currently deposited in the tomb or not.
    private boolean inTomb;
    
    public A1083359_Project2_Artifact(int type, int value)
    {
        super(type, value);
        this.inTomb = true;
    }
    ...
    @Override
    public void share(ArrayList<A1083359_Project2_Agent> receivers)
    {
        /********************************* TODO (Checkpoint 2) *********************************
        ...
        /************ START OF YOUR CODE ************/      
        A1083359_Project2_Artifact Artifact = new A1083359_Project2_Artifact(getType(), getValue());

        if(receivers.size()==1){
            for(A1083359_Project2_Agent receiver: receivers){
